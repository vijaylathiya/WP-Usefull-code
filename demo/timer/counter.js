...
setInterval(function() {
	...
	var timespan = countdown(new Date("05/29/2016 11:00:00"), nd);
    //var timespan = countdown(new Date("05/29/2016 11:00:00"), new Date());
    var div = document.getElementById('time');
	var sec;
	if (timespan.seconds < 10)
    	sec = "0" + timespan.seconds;
  	else
    	sec = timespan.seconds;
	var minu;
	if (timespan.minutes < 10)
    	minu = "0" + timespan.minutes;
  	else
    	minu = timespan.minutes;
	var day;
	if (timespan.days < 10)
    	day = "0" + timespan.days;
  	else
   ...
   // div.innerHTML = str
   document.getElementById('el_d1').innerHTML=day;
   document.getElementById('el_h1').innerHTML=timespan.hours;
   document.getElementById('el_m1').innerHTML=minu;
   document.getElementById('el_s1').innerHTML=sec;
}, 1000);
